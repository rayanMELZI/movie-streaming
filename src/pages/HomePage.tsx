      ...
      <main className="flex-1 p-6">
        ...
        <section>
          <div className="relative bg-gray-800 rounded-lg p-6">
            <img
              src="/path/to/house-of-wealth.jpg"
              alt="House of Wealth"
            ...
            <div className="relative z-10">
              ...
              <p className="mt-2 mb-4 text-gray-400">2023 | Drama | 2h 38m</p>
              <p className="mb-4">
...
//     <div className="flex">
//       {/* Sidebar */}
//       <div className="w-1/5 h-screen bg-gray-900 text-white p-6 space-y-4">
...
//           <Link
//             to="/favorites"
//             className="block hover:bg-gray-700 p-2 rounded-md"
//           >
//             Favourites
//           </Link>
//           <Link
...
//             Community
//           </Link>
//           <Link to="/social" className="block hover:bg-gray-700 p-2 rounded-md">
//             Social
//           </Link>
//           <Link
//             to="/settings"
...
//             Settings
//           </Link>
//           <Link to="/logout" className="block hover:bg-gray-700 p-2 rounded-md">
//             Logout
//           </Link>
//         </nav>
//       </div>
